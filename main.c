...
int		main(void)
{
	...
	printf("\n\n");
	printf("--string--\n");
	printf("%-60s: |%s|","format identifier", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%s|","FT format identifier", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%20s|", "with minimum field (20) width", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%20s|", "FT with minimum field (20) width", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%-20s|", "minimum field (20) left align", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%-20s|", "FT minimum field (20) left align", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%.8s|", "precision (8) field", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%.8s|", "FT precision (8) field", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%-.8s|", "precision (8) field left align", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%-.8s|", "FT precision (8) field left align", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%20.8s|", "minimum (20) and precision (8) field", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%20.8s|", "FT minimum (20) and precision (8) field", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%-20.8s|", "minimum (20) and precision (8) field left align", "quarante-deuze");
	printf("\n");
	ft_printf("%-60s: |%-20.8s|", "FT minimum (20) and precision (8) field left align", "quarante-deuze");
	printf("\n");
	printf("%-60s: |%-*.*s|", "star minimum (20) and precision (8) field left align", 20, 8, "quanrante deuzeeee");
	printf("\n");
	ft_printf("%-60s: |%-*.*s|", "FT star minimum (20) and precision (8) field left align", 20, 8, "quanrante deuzeeee");
	printf("\n\n");
